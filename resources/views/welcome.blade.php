        ...
        <div class="header">
            <div class="container">
                ...
                <div class="intro__inner">
                    <h1 class="intro__title">Добро пожаловать в FoodCenter</h1>
                    <h2 class="intro__subtitle">Быстрая и надежная доставка</h2>
                    <button class="btn btn-outline-dark text-white" type="submit">Читать далее</button>
                </div>
            </div>
